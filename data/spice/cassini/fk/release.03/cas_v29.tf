...
----------------------------------------------------------
   ...
   Cassini Frame Kernel Version:
           ...
           TEXT_KERNEL_ID += 'CASSINI_FRAMES V2.9.0 16-NOVEMBER-2000 FK'
...
High Gain Antenna (HGA)
   ...
   The XBAND, KABAND, KUBAND, and SBAND frames are all frames associated with
   the orbiter's High Gain Antenna. For reasons of consistency with AACS, PDT,
   and sequencing software these names were chosen.
...
----------------------------------------------------------
   ...
   this frame requires a C-kernel with appropriate coverage for the epochs of
   interest.
...
----------------------------------------------------------
   ...
   Since the instrument articulates, to make proper use of this frame requires
   a C-kernel with appropriate coverage for the epochs of interest.
...
----------------------------------------------------------
   ...
   Most of the components of the Magentospheric Imaging Instrument are mounted
...
(MIMI_LEMMS1)
   ...
   The MIMI_LEMMS detectors are mounted on an articulating platform. So making
   proper use of this frame requires a C-kernel with appropriate coverage for
